...
export const tutuong: Question[] = [
    {
        label: "4.1tt: Phân tích tư tưởng Hồ Chí Minh về xây dựng nhà nước pháp quyền.",
    ...
    {
        label: "4.2tt: Phân tích tư tưởng Hồ Chí Minh về xây dựng nhà nước dân chủ.",
    ...
    {
        label: "1.1tt: Phân tích tinh hoa văn hóa Phương Đông trong việc hình thành Tư tưởng Hồ Chí Minh, từ đó rút ra giá trị của tinh hoa ấy trong giai đoạn hiện nay?",
    ...
    {
        label: "1.2tt: Phân tích tinh hoa văn hóa Phương Tây trong việc hình thành Tư tưởng Hồ Chí Minh, Từ đó, liên hệ với việc tiếp thu giá trị văn hóa phương Tây trong giai đoạn hiện nay",
    ...
    {
        label: "7  tt: Phân tích nguyên tắc xây dựng đạo đức cách mạng và liên hệ với việc rèn luyện đạo đức của sinh viên hiện nay.",
    ...
    {
        label: "3 tt: Tại sao Đảng Cộng Sản Việt Nam phải lấy chủ nghĩa Mác-Lênin làm nền tảng theo Hồ Chí Minh",
