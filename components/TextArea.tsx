...
const TextArea = ({
  ...
  return (
    <div className="text-neutral-200 p-2 w-full rounded flex flex-col space-y-2 text-center">
      ...
      <textarea
        className="px-5 py-4 leading-7 tracking-wider bg-neutral-200 minscreen text-neutral-600 active:outline-none focus:outline-none rounded resize-none shadow-md cursor-default"
        placeholder={
          placeholder
            ? placeholder
