export const goicauhoitriet = [
  {
    label:
      "cau17: Tại sao mối quan hệ giữa tư duy và tồn tại hay giữa vật chất và ý thức là vấn đề cơ bản của triết học?",
    dapan: `– Khái niệm: vấn đề cơ bản lớn của mọi triết học, đặc biệt là của triết học hiện đại là vấn đề mối quan hệ giữa tư duy và tồn tại hay giữa vật chất và ý thức.
    – Vấn đề cơ bản của triết học có hai mặt:
    + Mặt thứ nhất trả lời câu hỏi: giữa vật chất và ý thức cái nào có trước cái nào có sau, cái nào có trước cái nào.
    + Mặt thứ hai trả lời câu hỏi: liệu con người có khả năng nhận thức được thế giới hay không.
    
    – Mối quan hệ giữa 1 hay giữa 2 là vấn đề cơ bản của triết học bởi vì:
    + Đây là vấn đề rộng nhất, chung nhất. Là nền tảng, định hướng để giải quyết các vấn đề khác.
    + Các trường phái triết học đều trực tiếp/ gián tiếp đi vào giải quyết mối quan hệ 1 hay 2 trước khi đi vào quyết định của mình.
    + Việc quyết định mối quan hệ 2 là cơ sở xuất phát cho các quyết định triết học nảy sinh.
    + Việc quyết định vấn đề cơ bản của triết học là tính chất khách quan khoa học để xác định lập trường tư tưởng triết học của các nhà triết học trong lịch sử.`,
  },
  {
    label:
      "cau18: Phân tích sự đối lập giữa phương pháp biện chứng và phương pháp siêu hình và ý nghĩa của hai phương pháp tư duy đó?",
    dapan: `• Phương pháp biện chứng:
  ...
  {
    label:
      "cau20: Có thể đồng nhất chất của sự vật với thuộc tính của sự vật được không? Tại sao?",
    dapan: `• Khái niệm chất: chất là khái niệm dùng để chỉ tính quy định khác quan vốn có của sự vật, hiện tượng, là sự thống nhất hữu cơ của các thuộc tính, yếu tố tạo nên sự vật, hiện tượng làm cho sự vật, hiện tượng là nó mà không phải sự vật, hiện tượng khác.
      ...
      – Chất là tổng hợp nhiều thuộc tính khách quan vốn có của sự vật, hiện tượng. Chỉ những thuộc tính cơ bản mới tạo thành chất của sự vật. Chất của sự vật được biểu hiện thông qua các thuộc tính cơ bản ở các quan hệ khác nhau. Mỗi sự vật có nhiều thuộc tính, do đó một sự vật hiện tượng có thể có nhiều chất.
      ...
      • Ví dụ: sắt là kim loại nên có đủ các tính chất chung của kim loại là tính dẻo, tính dẫn nhiệt, tính dẫn điện, có ánh kim. Nhưng ngoài ra sắt còn có thuộc tính riêng là từ tính.
      `,
  },
  {
    label:
      "cau21: Tại sao nói, trong các hình thức cơ bản của hoạt động thực tiễn, hoạt động sản xuất vật chất đóng vai trò quyết định nhất?",
    dapan: `Thực tiễn:
  ...
  {
    label:
      "cau22: Trong kết cấu của lực lượng sản xuất(LLSX), yếu tố nào giữ vai trò quyết định nhất? Tại sao?",
    dapan: `• Người lao động giữ vai trò quyết định nhất.

    – Lực lượng sản xuất: là sự kết hợp giữa người lao động với tư liệu sản xuất, tạo ra sức sản xuất và năng lực thực tiễn làm biến đổi các đối tượng vật chất của thế giới tự nhiên theo nhu cầu nhất định của con người và xã hội
    – Kết cấu của lực lượng sản xuất bao gồm:
    + Người lao động: là con người có tri thức, kinh nghiệm, kỹ năng lao động và năng lực sáng tạo nhất định trong quá trình sản xuất của xã hội. Là chủ thể sáng tạo, đồng thời là chủ thể tiêu dùng mọi của cải vật chất của xã hội. Đây là nguồn lực cơ bản, vô tận và đặc biệt của sản xuất.
    + Các tư liệu sản xuất: là điều kiện vật chất cần thiết để tổ chức sản xuất, bao gồm tư liệu lao động và đối tượng lao động.
    · Đối tượng lao động là những yếu tố vật chất của sản xuất mà con người lao động dùng tư liệu lao động tác động lên, nhằm biến đổi chúng cho phù hợp với mục đích sử dụng của con người. Gồm: tự nhiên có sẵn và đã qua chế biến.
    · Tư liệu lao động là yếu tố vật chất của sản xuất mà con người dựa vào đó để tác động lên đối tượng lao động, nhằm biến đổi đối tượng lao động thành sản phẩm cho phù hợp với mục đích sử dụng của con người. Gồm: công cụ lao động và phương tiện lao động.
    
      
    • Trong kết cấu của LLSX người lao động giữ vai trò quyết định nhất vì:
    – Người lao động là lực lượng cơ bản sáng tạo ra công cụ lao động và trực tiếp sử dụng công cụ lao động để tạo ra của cải vật chất cho xã hội. Các giá trị và hiệu quả thực tế của công cụ lao động phụ thuộc vào trình độ thực tế sử dụng và sáng tạo của người lao động.
    – Người lao động là chủ thể của quá trình sản xuất, quyết định tới phương hướng, quy mô, trình độ, năng suất ... của quá trình sản xuất.
    – Cùng với quá trình lao động sản xuất, sức mạnh và kỹ năng lao động của con người ngày càng tăng lên, đặc biệt là hàm lượng trí tuệ và làm cho họ trở thành yếu tố quyết định của lực lượng sản xuất xã hội
    
    `,
  },
  {
    label:
      "cau23: Trong kết cấu của lực lượng sản xuất (LLSX) yếu tố nào động nhất, cách mạng nhất? Tại sao? ",
    dapan: `Các khái niệm:
    – Lực lượng sản xuất: là sự kết hợp giữa người lao động với tư liệu sản xuất, tạo ra sức sản xuất và năng lực thực tiễn làm biến đổi các đối tượng vật chất của thế giới tự nhiên theo nhu cầu nhất định của con người và xã hội
    – Kết cấu của lực lượng sản xuất bao gồm:
    + Người lao động: là con người có tri thức, kinh nghiệm, kỹ năng lao động và năng lực sáng tạo nhất định trong quá trình sản xuất của xã hội. Là chủ thể sáng tạo, đồng thời là chủ thể tiêu dùng mọi của cải vật chất của xã hội. Đây là nguồn lực cơ bản, vô tận và đặc biệt của sản xuất.
    ...
    • Trong kết cấu LLSX. công cụ là động là yếu tố động nhất, cách mạng nhất vì:
    ...
    – Công cụ lao động là yếu tố động nhất vì: Công cụ lao động là yếu tố mà con người luôn tìm cách cả tiến và phát minh mới không ngừng nhằm thỏa mãn những nhu cầu của con người trong sản xuất: tăng năng suất lao động nhưng giảm thời gian lao động, giảm công sức lao đông
    – Là yếu tố cách mạng nhất vì sự thay đổi, phát triển của nó khiến LLSX phát triển không ngừng, kéo theo sự thay đổi QHSX, từ đó làm thay đổi PTSX và thay đổi xã hội.
    
      `,
  },
  {
    label:
      "cau24: Tại sao khoa học là lực lượng sản xuất( LLSX) trực tiếp của xã hội hiện nay? Cho ví dụ ? ",
    dapan: `• Khái niệm
    – Lực lượng sản xuất: là sự kết hợp giữa người lao động với tư liệu sản xuất, tạo ra sức sản xuất và năng lực thực tiễn làm biến đổi các đối tượng vật chất của thế giới tự nhiên theo nhu cầu nhất định của con người và xã hội
    – Kết cấu của lực lượng sản xuất bao gồm:
    + Người lao động: là con người có tri thức, kinh nghiệm, kỹ năng lao động và năng lực sáng tạo nhất định trong quá trình sản xuất của xã hội. Là chủ thể sáng tạo, đồng thời là chủ thể tiêu dùng mọi của cải vật chất của xã hội. Đây là nguồn lực cơ bản, vô tận và đặc biệt của sản xuất.
    ...
    – Khoa học trực tiếp sản xuất ra các loại hàng hoá đặc biệt, như phát minh; sáng chế; quy trình công nghệ và trở thành ngành sản xuất với đầu tư ngày càng tăng. Ví dụ: Nhiều phát minh về các cánh tay robot tự động hóa các quy trình sản xuất, các công nghệ sản xuất dây chuyền tối ưu hóa,...
    
    – Khoa học ngày càng thâm nhập sâu vào mọi thành tố của LLSX, trở thành mắt khâu bên trong của quá trình sản xuất, là nguyên nhân của mọi biến đổi trong sản xuất. Minh chứng rõ nhất là mọi doanh nghiệp hiện nay đều ứng dụng một hay nhiều thành tựu khoa học vào trong các khâu sản xuất của mình.
    
    – Khoa học đi vào hợp lý hoá quá trình tổ chức, quản lý sản xuất, nâng cao năng suất lao động.
    Ví dụ: Một trí tuệ nhân tạo đóng vai trò như một người điều hành các chuỗi dây chuyền, máy móc, quản lý cả một nhà máy sản xuất mà không cần sự can thiệp trực tiếp của con người.
    
    – Phát minh khoa học làm xuất hiện những ngành sản xuất mới, những máy móc thiết bị mới, công nghệ mới, nguyên vật liệu mới, năng lượng mới. Ví dụ: Phát minh khoa học làm xuất hiện ngành công nghiệp mới là sản xuất ô tô điện, với nhiều công nghệ mới như cảnh báo nguy hiểm, lái tự động,...; Hay khoa học làm xuất hiện những nguyên liệu mới như vật liệu nano, năng lượng mới như địa nhiệt, hạt nhân,...
  ...
  {
    label:
      "cau25: Tại sao ý thức xã hội thường lạc hậu hơn so với tồn tại xã hội? Cho ví dụ chứng minh?",
    dapan: `• Các khái niệm:
    ...
    – Ý thức xã hội gắn liền với lợi ích của những tập đoàn người, của các giai cấp nào đó trong xã hội. Các tập đoàn hay giai cấp lạc hậu thường níu kéo, bám chặt vào những tư tưởng lạc hậu để bảo vệ và duy trì quyền lợi ích kỉ của họ, chống lại các lực lượng tiến bộ trong xã hội. Ví dụ: khoa học phát triển nhanh chóng nhưng ý thức con người chưa phát triển, còn nhiều phong tục tập quán lạc hậu.
    ...
    • Ví dụ: Một số vùng quê ở việt nam tuy có điều kiện kinh tế phát triển nhưng vẫn có phong tục, tập quán lạc hậu như tảo hôn,...
    
      `,
  },
  {
    label:
      "cau26: Tính vượt trước của ý thức xã hội so với tồn tại xã hội? Ý nghĩa của nó trong việc xây dựng đời sống tinh thần ở Việt Nam hiện nay? ",
    dapan: `• Các khái niệm:
    – Tồn tại xã hội: Tồn tại xã hội là toàn bộ sinh hoạt vật chất và những điều kiện sinh hoạt vật chất của xã hội.
    – Các yếu tố của tồn tại xã hội:
    + Phương thức sản xuất vật chất (LLSX và QHSX)
